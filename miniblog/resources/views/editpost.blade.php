                ...
                <div class="p-6 bg-gray-700">
                    <form action="" class="w-full max-w-sm" method="POST">
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="text" class="border-2 border-gray-200 rounded w-full py-2 px-4"
                        ...
                        <div class="md:flex md:items-center mb-6">
                            <div class="md:w-1/3">
                                <label for="body"
                                    class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4">Body</label>
                            </div>
                            <div class="md:w-2/3">
                                <textarea name="body" id="body"  class="resize border rounded-md"  style="width: 255px">{{$post->body}}</textarea>
                            </div>
                        </div>
